   ...
   if(isset($_POST['submit'])) {
    ...
    switch($action){
      case "upd":
          ...
          CallInsertJournal($IDUSER,64,$LOGIN." a modifié Energie machine '".$design."' (".$genre."/".$statut.")");
          }
          break;
      case "add":
          if ($design){
          ...
          CallInsertJournal($IDUSER,64,$LOGIN." a ajouté Energie machine '".$design."' (".$genre."/".$statut.")");
          }
          break;
      case "del":
          if ($id){  
          CallDeleteEnergieMachine($id);
          echo "<div class='tempmodal green'>Vos données ont été effacées</div>";
          CallInsertJournal($IDUSER,64,$LOGIN." a effacé Energie machine '".$design."' (".$genre."/".$statut.")");
          }
          break;
...
echo "<div class='titrepage'>Energies de Machines</div>";
